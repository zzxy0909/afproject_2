...
{	
	BezierCurve curve;
    SerializedProperty lineRendererProp;
	...
	void OnEnable()
	{
        ...
        lineRendererProp = serializedObject.FindProperty("m_LineRenderer");
...
//        EditorGUILayout.PropertyField(lineRendererProp);
		...
		if(showPoints)
		{
			...
			if(GUILayout.Button("Add Point"))
			{
                ...
                LineRenderer line_renderer = pointObject.AddComponent<LineRenderer>();
                newPoint.m_LineRenderer = line_renderer;
